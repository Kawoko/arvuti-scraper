...
export const snapshotRowSchema = z.object({
  ...
  category: z.enum(["ram", "gpu", "cpu", "hdd", "ssd", "custom"]),
  source_category: z.enum(["ram", "gpu", "cpu", "hdd", "ssd", "custom"]).nullable(),
  chipset: z.string().nullable(),
  family: z.string().nullable(),
  socket: z.string().nullable(),
  read_speed_mbs: z.number().int().nonnegative().nullable(),
  write_speed_mbs: z.number().int().nonnegative().nullable(),
  interface_type: z.string().nullable(),
